  ...
  const panes = [
    {
      ...
      pane: (
        <Tab.Pane key="query-params">
          <KeyValuePane keyPairs={queryParams} setKeyPairs={setQueryParams} />
        </Tab.Pane>
      ),
    },
    {
      menuItem: "Headers",
      pane: (
        <Tab.Pane key="headers">
          <KeyValuePane keyPairs={headers} setKeyPairs={setHeaders} />
        </Tab.Pane>
      ),
    },
    {
      menuItem: "Body",
      pane: (
        <Tab.Pane key="json-editor">
          <CodeMirrorEditorPane doc={doc} setDoc={setDoc} />
        </Tab.Pane>
      ),
    },
  ];
